  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <p>Membuat Array siswa adalah salah satu tugas praktikum 1</p>
          </div>
          <div class="col-sm-6">
...
<!-- tutup table -->
              ...
              <div class="card-body">
                Pada pekan ini melakukan praktikum dengan materi array, variabel dan konstanta, serta variabel sistem.
              </div>
              <!-- /.card-body -->
